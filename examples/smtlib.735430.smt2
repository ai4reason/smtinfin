...
(declare-fun f31 () S22)
(declare-fun f32 () S4)
(declare-fun f33 (S23 Int) S5)
(declare-fun f34 () S23)
(declare-fun f35 (S24 S5) Int)
(declare-fun f36 () S24)
(declare-fun f37 (S25 S4) S6)
(declare-fun f38 () S25)
(declare-fun f39 () S25)
(declare-fun f40 (S27 S3) S5)
...
(assert (forall ((?v0 S4) (?v1 S5)) (=> (forall ((?v2 S3)) (=> (= (f7 (f8 f9 ?v2) ?v0) f1) (= (f5 (f11 f12 (f33 f34 (+ (f35 f36 ?v1) 1))) ?v2) f1))) (forall ((?v2 S3)) (=> (= (f7 (f8 f9 ?v2) ?v0) f1) (= (f5 (f11 f12 ?v1) ?v2) f1))))))
(assert (forall ((?v0 S5) (?v1 S3)) (=> (= (f5 (f11 f12 (f33 f34 (+ (f35 f36 ?v0) 1))) ?v1) f1) (= (f5 (f11 f12 ?v0) ?v1) f1))))
(assert (forall ((?v0 S4) (?v1 S4)) (= (= (f7 (f37 f38 ?v0) ?v1) f1) (forall ((?v2 S5)) (=> (forall ((?v3 S3)) (=> (= (f7 (f8 f9 ?v3) ?v0) f1) (= (f5 (f11 f12 ?v2) ?v3) f1))) (forall ((?v3 S3)) (=> (= (f7 (f8 f9 ?v3) ?v1) f1) (= (f5 (f11 f12 ?v2) ?v3) f1))))))))
(assert (forall ((?v0 S4) (?v1 S12) (?v2 S18) (?v3 S14)) (let ((?v_0 (f37 f39 ?v0)) (?v_1 (f27 f28 ?v1))) (=> (= (f7 ?v_0 (f13 (f14 f15 (f16 (f17 (f18 f19 (f26 ?v_1 ?v2)) ?v3) ?v1)) f32)) f1) (= (f7 ?v_0 (f13 (f14 f15 (f16 (f17 (f18 f19 ?v1) (f21 (f22 f23 ?v2) ?v3)) (f26 ?v_1 (f29 (f30 f31 f4) ?v2)))) f32)) f1)))))
...
(assert (forall ((?v0 S26) (?v1 S12) (?v2 S14) (?v3 S12)) (= (f40 (f41 f42 ?v0) (f16 (f17 (f18 f19 ?v1) ?v2) ?v3)) (f33 f34 0))))
...
(assert (forall ((?v0 S4) (?v1 S4) (?v2 S4)) (let ((?v_0 (f37 f39 ?v2))) (=> (= (f7 (f37 f39 ?v0) ?v1) f1) (=> (= (f7 ?v_0 ?v0) f1) (= (f7 ?v_0 ?v1) f1))))))
(assert (forall ((?v0 S4)) (= (f7 (f37 f39 ?v0) f32) f1)))
(assert (forall ((?v0 S4) (?v1 S3) (?v2 S4)) (let ((?v_0 (f37 f39 ?v0)) (?v_1 (f14 f15 ?v1))) (=> (= (f7 ?v_0 (f13 ?v_1 ?v2)) f1) (and (= (f7 ?v_0 (f13 ?v_1 f32)) f1) (= (f7 ?v_0 ?v2) f1))))))
(assert (forall ((?v0 S4) (?v1 S3) (?v2 S4)) (let ((?v_0 (f37 f39 ?v0)) (?v_1 (f14 f15 ?v1))) (=> (= (f7 ?v_0 (f13 ?v_1 f32)) f1) (=> (= (f7 ?v_0 ?v2) f1) (= (f7 ?v_0 (f13 ?v_1 ?v2)) f1))))))
(assert (forall ((?v0 S4) (?v1 S3)) (=> (= ?v0 f32) (not (= (f7 (f8 f9 ?v1) ?v0) f1)))))
(assert (forall ((?v0 S4)) (= (= (f13 f43 ?v0) f32) (forall ((?v1 S3)) (not (= (f5 ?v0 ?v1) f1))))))
(assert (forall ((?v0 S3)) (= (= (f7 (f8 f9 ?v0) f32) f1) false)))
(assert (forall ((?v0 S4)) (= (= f32 (f13 f43 ?v0)) (forall ((?v1 S3)) (not (= (f5 ?v0 ?v1) f1))))))
...
(assert (forall ((?v0 S5)) (= (f33 f34 (f35 f36 ?v0)) ?v0)))
