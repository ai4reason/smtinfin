...
(assert (forall ((?v0 S17) (?v1 S6) (?v2 S11) (?v3 S6)) (let ((?v_0 (f10 f11 ?v1))) (= (= (f3 (f24 ?v0) (f8 (f9 ?v_0 (f18 f19 (f20 ?v2))) ?v3)) f1) (= (f3 (f24 (f25 f26 (+ (f27 f28 ?v0) 1))) (f8 (f9 ?v_0 (f13 f14 ?v2)) ?v3)) f1)))))
(assert (forall ((?v0 S2) (?v1 S2) (?v2 S3)) (=> (= (f29 ?v0 (f6 (f7 ?v1) ?v2)) f1) (=> (=> (= ?v0 ?v1) false) (=> (=> (= (f29 ?v0 ?v2) f1) false) false)))))
(assert (forall ((?v0 S2) (?v1 S3) (?v2 S2)) (=> (=> (not (= (f29 ?v0 ?v1) f1)) (= ?v0 ?v2)) (= (f29 ?v0 (f6 (f7 ?v2) ?v1)) f1))))
(assert (forall ((?v0 S2)) (=> (= (f29 ?v0 f21) f1) false)))
(assert (forall ((?v0 S20) (?v1 S6) (?v2 S8) (?v3 S6)) (= (f30 (f31 f32 ?v0) (f8 (f9 (f10 f11 ?v1) ?v2) ?v3)) (f25 f26 0))))
...
(assert (forall ((?v0 S3) (?v1 S2)) (=> (= ?v0 f21) (not (= (f29 ?v1 ?v0) f1)))))
(assert (forall ((?v0 S3)) (= (= (f33 ?v0) f21) (forall ((?v1 S2)) (not (= (f3 ?v0 ?v1) f1))))))
(assert (forall ((?v0 S2)) (= (= (f29 ?v0 f21) f1) false)))
(assert (forall ((?v0 S3)) (= (= f21 (f33 ?v0)) (forall ((?v1 S2)) (not (= (f3 ?v0 ?v1) f1))))))
(assert (forall ((?v0 S3)) (= (forall ((?v1 S2)) (=> (= (f29 ?v1 f21) f1) (= (f3 ?v0 ?v1) f1))) true)))
(assert (forall ((?v0 S3)) (= (exists ((?v1 S2)) (and (= (f29 ?v1 f21) f1) (= (f3 ?v0 ?v1) f1))) false)))
(assert (forall ((?v0 S3)) (= (exists ((?v1 S2)) (= (f29 ?v1 ?v0) f1)) (not (= ?v0 f21)))))
(assert (forall ((?v0 S3)) (= (forall ((?v1 S2)) (not (= (f29 ?v1 ?v0) f1))) (= ?v0 f21))))
(assert (= f21 (f33 f4)))
(assert (forall ((?v0 S2) (?v1 S3)) (=> (= (f29 ?v0 ?v1) f1) (= (f6 (f7 ?v0) ?v1) ?v1))))
(assert (forall ((?v0 S2) (?v1 S3) (?v2 S2)) (=> (= (f29 ?v0 ?v1) f1) (= (f29 ?v0 (f6 (f7 ?v2) ?v1)) f1))))
(assert (forall ((?v0 S2) (?v1 S3) (?v2 S3)) (let ((?v_0 (f7 ?v0))) (=> (not (= (f29 ?v0 ?v1) f1)) (=> (not (= (f29 ?v0 ?v2) f1)) (= (= (f6 ?v_0 ?v1) (f6 ?v_0 ?v2)) (= ?v1 ?v2)))))))
