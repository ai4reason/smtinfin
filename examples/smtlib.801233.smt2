...
(assert (=> (forall ((?v0 S4)) (=> (= (f30 (f31 f32 ?v0) f36) f1) (= (f21 (f22 f23 f28) ?v0) f1))) (forall ((?v0 S2)) (=> (= (f41 (f42 f43 ?v0) f40) f1) (= (f21 (f22 f23 f28) (f5 (f6 (f7 f8 (f9 f10 ?v0)) (f11 f12 ?v0)) (f9 f13 ?v0))) f1)))))
(assert (forall ((?v0 S4)) (=> (= (f30 (f31 f32 ?v0) f36) f1) (= (f21 (f22 f23 (f24 f25 (+ (f26 f27 f28) 1))) ?v0) f1))))
