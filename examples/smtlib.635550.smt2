...
(assert (let ((?v_0 (f11 f12 f13))) (= (f5 (f7 (f8 (f9 (f10 ?v_0 (f14 f15 f16)) f17)) f6) (f7 (f8 (f9 (f10 ?v_0 (f19 f20 (f21 f16))) f17)) f18)) f1)))
...
(assert (forall ((?v0 S2) (?v1 S2) (?v2 S3)) (= (= (f29 ?v0 (f7 (f8 ?v1) ?v2)) f1) (or (= ?v0 ?v1) (= (f29 ?v0 ?v2) f1)))))
