...
(declare-fun f42 (S10) S1)
(declare-fun f43 (S28 S7) S25)
(declare-fun f44 () S28)
(assert (not (= f1 f2)))
...
(assert (forall ((?v0 S2) (?v1 S15) (?v2 S22) (?v3 S15)) (let ((?v_0 (f24 f25 ?v1))) (= (= (f5 (f6 ?v0) (f22 (f23 ?v_0 (f39 f40 (f41 ?v2))) ?v3)) f1) (= (f5 (f6 (f17 f18 (+ (f19 f20 ?v0) 1))) (f22 (f23 ?v_0 (f32 f33 ?v2)) ?v3)) f1)))))
(assert (=> (= (f42 f27) f1) (=> false false)))
(assert (forall ((?v0 S10) (?v1 S10)) (=> (= (f42 (f12 (f37 f38 ?v0) ?v1)) f1) (=> (=> (= (f42 ?v0) f1) (=> (= (f42 ?v1) f1) false)) false))))
(assert (forall ((?v0 S7) (?v1 S6) (?v2 S10) (?v3 S2) (?v4 S6) (?v5 S10)) (=> (not (= (f7 ?v0 ?v1) f1)) (=> (= (f7 (f9 (f10 (f11 ?v2) ?v1) ?v3) ?v4) f1) (= (f7 (f9 (f10 (f11 (f12 (f37 (f43 f44 ?v0) ?v5) ?v2)) ?v1) ?v3) ?v4) f1)))))
(assert (forall ((?v0 S7) (?v1 S6) (?v2 S10) (?v3 S2) (?v4 S6) (?v5 S10)) (=> (= (f7 ?v0 ?v1) f1) (=> (= (f7 (f9 (f10 (f11 ?v2) ?v1) ?v3) ?v4) f1) (= (f7 (f9 (f10 (f11 (f12 (f37 (f43 f44 ?v0) ?v2) ?v5)) ?v1) ?v3) ?v4) f1)))))
(assert (forall ((?v0 S7) (?v1 S10) (?v2 S10) (?v3 S6) (?v4 S2) (?v5 S6)) (let ((?v_0 (= (f7 ?v0 ?v3) f1))) (=> (= (f7 (f9 (f10 (f11 (f12 (f37 (f43 f44 ?v0) ?v1) ?v2)) ?v3) ?v4) ?v5) f1) (=> (=> ?v_0 (=> (= (f7 (f9 (f10 (f11 ?v1) ?v3) ?v4) ?v5) f1) false)) (=> (=> (not ?v_0) (=> (= (f7 (f9 (f10 (f11 ?v2) ?v3) ?v4) ?v5) f1) false)) false))))))
(assert (forall ((?v0 S7) (?v1 S10)) (=> (= (f42 (f12 (f13 f14 ?v0) ?v1)) f1) (=> (=> (= (f42 ?v1) f1) false) false))))
(assert (forall ((?v0 S7) (?v1 S10) (?v2 S10)) (=> (= (f42 (f12 (f37 (f43 f44 ?v0) ?v1) ?v2)) f1) (=> (=> (= (f42 ?v1) f1) (=> (= (f42 ?v2) f1) false)) false))))
(assert (forall ((?v0 S22) (?v1 S6) (?v2 S2) (?v3 S6)) (=> (= (f7 (f9 (f10 (f11 (f39 f40 (f41 ?v0))) ?v1) ?v2) ?v3) f1) (= (f7 (f9 (f10 (f11 (f32 f33 ?v0)) ?v1) (f17 f18 (+ (f19 f20 ?v2) 1))) ?v3) f1))))
(assert (forall ((?v0 S10) (?v1 S10) (?v2 S7)) (=> (= (f42 ?v0) f1) (=> (= (f42 ?v1) f1) (= (f42 (f12 (f37 (f43 f44 ?v2) ?v0) ?v1)) f1)))))
(assert (forall ((?v0 S7) (?v1 S10) (?v2 S10) (?v3 S7) (?v4 S10) (?v5 S10)) (= (= (f12 (f37 (f43 f44 ?v0) ?v1) ?v2) (f12 (f37 (f43 f44 ?v3) ?v4) ?v5)) (and (= ?v0 ?v3) (and (= ?v1 ?v4) (= ?v2 ?v5))))))
(assert (forall ((?v0 S10) (?v1 S7)) (=> (= (f42 ?v0) f1) (= (f42 (f12 (f13 f14 ?v1) ?v0)) f1))))
(assert (forall ((?v0 S7) (?v1 S10) (?v2 S10) (?v3 S22)) (not (= (f12 (f37 (f43 f44 ?v0) ?v1) ?v2) (f32 f33 ?v3)))))
